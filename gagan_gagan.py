...
def p_declarations(p):
    '''declarations : type_specifier ID SEMICOLON
                    | type_specifier ID SEMICOLON declarations
    '''
    if len(p) == 4:
        p[0] = [('declaration', p[1], [p[2]])]
    else:
...
def p_statement(p):
    '''statement : IF LPAREN expression RPAREN LBRACE program RBRACE
                 ...
                 | STRUCT ID LBRACE declarations RBRACE SEMICOLON
    '''
